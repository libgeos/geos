...
*/
void planarDirectedEdgeStar::add(planarDirectedEdge *de){
...
*/
void planarDirectedEdgeStar::remove(planarDirectedEdge *de){
...
*/
vector<planarDirectedEdge*>::iterator planarDirectedEdgeStar::iterator() {
	sortEdges();
...
*/
int planarDirectedEdgeStar::getDegree() { 
...
*/
Coordinate& planarDirectedEdgeStar::getCoordinate() {
	if (outEdges->empty())
...
*/
vector<planarDirectedEdge*>* planarDirectedEdgeStar::getEdges(){
	sortEdges();
	return outEdges;
}
...
void planarDirectedEdgeStar::sortEdges(){
	if (!sorted) {
...
*/
int planarDirectedEdgeStar::getIndex(planarEdge *edge){
	sortEdges();
	for (int i = 0; i<(int)outEdges->size(); i++) {
...
* by angle with the positive x-axis.
*/  
int planarDirectedEdgeStar::getIndex(planarDirectedEdge *dirEdge){
	sortEdges();
	for (int i = 0; i <(int) outEdges->size(); i++) {
		planarDirectedEdge *de =(*outEdges)[i];
		if (de == dirEdge)
...
* DirectedEdgeStar. 
*/
int planarDirectedEdgeStar::getIndex(int i){
...
*/
planarDirectedEdge* planarDirectedEdgeStar::getNextEdge(planarDirectedEdge *dirEdge){
