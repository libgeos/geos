...
struct test_envelope_data {
    ...
    static void
    check_intersects(const Envelope& e1, const Coordinate& q, bool expected)
    {
        ...
        if (!e1.isNull()) {
            Coordinate p0{e1.getMinX(), e1.getMinY()};
            Coordinate p1{e1.getMaxX(), e1.getMaxY()};
...
()
{
    ...
    ensure_equals(c, Coordinate{0.5, 3});
