...
SWIGINTERN int GeosCoordinateSequence_getSize(GeosCoordinateSequence *self){
        size_t result;
        GEOSCoordSeq coords = (GEOSCoordSeq) self;
        GEOSCoordSeq_getSize(coords, &result);
        return result;
    }
SWIGINTERN int GeosCoordinateSequence_getDimensions(GeosCoordinateSequence *self){
        size_t result;
        GEOSCoordSeq coords = (GEOSCoordSeq) self;
...
_wrap_CoordinateSequence___len__(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< GeosCoordinateSequence * >(argp1);
  {
    try
    {
      result = (int)GeosCoordinateSequence_getSize(arg1);
    }
    catch (const std::exception& e)
    {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN VALUE
_wrap_CoordinateSequence_get_dimensions(int argc, VALUE *argv, VALUE self) {
  GeosCoordinateSequence *arg1 = (GeosCoordinateSequence *) 0 ;
  int result;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  arg1 = reinterpret_cast< GeosCoordinateSequence * >(argp1);
  {
    try
    {
      result = (int)GeosCoordinateSequence_getDimensions(arg1);
    }
    catch (const std::exception& e)
    {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN VALUE
_wrap_Geometry_get_srid(int argc, VALUE *argv, VALUE self) {
  GeosGeometry *arg1 = (GeosGeometry *) 0 ;
  int result;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_Geometry_set_srid(int argc, VALUE *argv, VALUE self) {
  GeosGeometry *arg1 = (GeosGeometry *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_Geometry_get_dimensions(int argc, VALUE *argv, VALUE self) {
  GeosGeometry *arg1 = (GeosGeometry *) 0 ;
  size_t result;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_Geometry_get_num_geometries(int argc, VALUE *argv, VALUE self) {
  GeosGeometry *arg1 = (GeosGeometry *) 0 ;
  size_t result;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_Geometry_get_centroid(int argc, VALUE *argv, VALUE self) {
  GeosGeometry *arg1 = (GeosGeometry *) 0 ;
  GeosGeometry *result = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_Geometry_is_emptyq___(int argc, VALUE *argv, VALUE self) {
  GeosGeometry *arg1 = (GeosGeometry *) 0 ;
  bool result;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_Geometry_is_validq___(int argc, VALUE *argv, VALUE self) {
  GeosGeometry *arg1 = (GeosGeometry *) 0 ;
  bool result;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_Geometry_is_simpleq___(int argc, VALUE *argv, VALUE self) {
  GeosGeometry *arg1 = (GeosGeometry *) 0 ;
  bool result;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_Geometry_is_ringq___(int argc, VALUE *argv, VALUE self) {
  GeosGeometry *arg1 = (GeosGeometry *) 0 ;
  bool result;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_Point_get_coord_seq(int argc, VALUE *argv, VALUE self) {
...
SWIGINTERN VALUE
_wrap_LineString_get_coord_seq(int argc, VALUE *argv, VALUE self) {
...
SWIGINTERN VALUE
_wrap_LinearRing_get_coord_seq(int argc, VALUE *argv, VALUE self) {
...
SWIGINTERN VALUE
_wrap_Polygon_get_exterior_ring(int argc, VALUE *argv, VALUE self) {
...
SWIGINTERN VALUE
_wrap_Polygon_get_num_interior_rings(int argc, VALUE *argv, VALUE self) {
  GeosPolygon *arg1 = (GeosPolygon *) 0 ;
  size_t result;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_Polygon_get_interior_ring_n(int argc, VALUE *argv, VALUE self) {
  GeosPolygon *arg1 = (GeosPolygon *) 0 ;
  size_t arg2 ;
  GeosGeometry *result = 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN VALUE
_wrap_get_wkb_output_dimensions(int argc, VALUE *argv, VALUE self) {
  int result;
  VALUE vresult = Qnil;
...
SWIGINTERN VALUE
_wrap_set_wkb_output_dimensions(int argc, VALUE *argv, VALUE self) {
  int arg1 ;
  int result;
  int val1 ;
  int ecode1 = 0 ;
...
SWIGINTERN VALUE
_wrap_get_wkb_byte_order(int argc, VALUE *argv, VALUE self) {
  int result;
  VALUE vresult = Qnil;
...
SWIGINTERN VALUE
_wrap_set_wkb_byte_order(int argc, VALUE *argv, VALUE self) {
  int arg1 ;
  int result;
  int val1 ;
  int ecode1 = 0 ;
...
SWIGEXPORT void Init_geos(void) {
  ...
  rb_define_const(mGeos, "GEOS_VERSION", SWIG_FromCharPtr("3.0.0rc1"));
  ...
  rb_define_const(mGeos, "GEOS_CAPI_VERSION_MINOR", SWIG_From_int(static_cast< int >(1)));
  ...
  rb_define_const(mGeos, "GEOS_CAPI_LAST_INTERFACE", SWIG_From_int(static_cast< int >((1+1))));
  rb_define_const(mGeos, "GEOS_CAPI_VERSION", SWIG_FromCharPtr("3.0.0rc1-CAPI-1.1.1"));
  ...
  rb_define_method(cCoordinateSequence.klass, "get_dimensions", VALUEFUNC(_wrap_CoordinateSequence_get_dimensions), -1);
  ...
  rb_define_alias(cGeometry.klass, "srid=", "set_srid");
  rb_define_method(cGeometry.klass, "get_dimensions", VALUEFUNC(_wrap_Geometry_get_dimensions), -1);
  rb_define_method(cGeometry.klass, "get_num_geometries", VALUEFUNC(_wrap_Geometry_get_num_geometries), -1);
  ...
  rb_define_method(cGeometry.klass, "get_centroid", VALUEFUNC(_wrap_Geometry_get_centroid), -1);
  ...
  rb_define_method(cGeometry.klass, "is_ring?", VALUEFUNC(_wrap_Geometry_is_ringq___), -1);
  ...
  rb_define_method(cPoint.klass, "get_coord_seq", VALUEFUNC(_wrap_Point_get_coord_seq), -1);
  cPoint.mark = 0;
  ...
  rb_define_method(cLineString.klass, "get_coord_seq", VALUEFUNC(_wrap_LineString_get_coord_seq), -1);
  cLineString.mark = 0;
  ...
  rb_define_method(cLinearRing.klass, "get_coord_seq", VALUEFUNC(_wrap_LinearRing_get_coord_seq), -1);
  cLinearRing.mark = 0;
  ...
  rb_define_method(cPolygon.klass, "get_exterior_ring", VALUEFUNC(_wrap_Polygon_get_exterior_ring), -1);
  rb_define_method(cPolygon.klass, "get_num_interior_rings", VALUEFUNC(_wrap_Polygon_get_num_interior_rings), -1);
  rb_define_method(cPolygon.klass, "get_interior_ring_n", VALUEFUNC(_wrap_Polygon_get_interior_ring_n), -1);
  cPolygon.mark = 0;
  ...
  rb_define_module_function(mGeos, "get_wkb_output_dimensions", VALUEFUNC(_wrap_get_wkb_output_dimensions), -1);
  rb_define_module_function(mGeos, "set_wkb_output_dimensions", VALUEFUNC(_wrap_set_wkb_output_dimensions), -1);
  rb_define_module_function(mGeos, "get_wkb_byte_order", VALUEFUNC(_wrap_get_wkb_byte_order), -1);
  rb_define_module_function(mGeos, "set_wkb_byte_order", VALUEFUNC(_wrap_set_wkb_byte_order), -1);
